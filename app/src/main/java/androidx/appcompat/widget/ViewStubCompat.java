...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context context, AttributeSet attributeSet, int i10) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2957j.f12455X3, i10, 0);
        this.mInflatedId = obtainStyledAttributes.getResourceId(C2957j.f12471a4, -1);
        this.mLayoutResource = obtainStyledAttributes.getResourceId(C2957j.f12465Z3, 0);
        setId(obtainStyledAttributes.getResourceId(C2957j.f12460Y3, -1));
