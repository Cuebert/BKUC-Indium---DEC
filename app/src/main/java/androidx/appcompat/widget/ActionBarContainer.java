...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C2953f.f12266a);
        this.mContextView = findViewById(C2953f.f12271f);
    }
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        C0690v.m3859t0(this, new C0248a(this));
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2957j.f12466a);
        this.mBackground = obtainStyledAttributes.getDrawable(C2957j.f12472b);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C2957j.f12482d);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C2957j.f12512j, -1);
        boolean z10 = true;
        if (getId() == C2953f.f12257N) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C2957j.f12477c);
        }
