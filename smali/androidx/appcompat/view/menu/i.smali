...
.method private a()Landroidx/appcompat/view/menu/h;
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->e(Landroidx/appcompat/view/menu/e;)V

    .line 10
    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->r(Landroid/widget/PopupWindow$OnDismissListener;)V

    .line 11
    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->m(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->p(I)V
...
.method private n(IIZZ)V
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/i;->e()Landroidx/appcompat/view/menu/h;

    move-result-object v0

    .line 2
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/h;->s(Z)V
    ...
    .line 4
    invoke-static {p4}, Landroidx/core/view/v;->E(Landroid/view/View;)I
    ...
    .line 7
    :cond_0
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/h;->q(I)V

    .line 8
    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/h;->t(I)V
    ...
    .line 11
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/h;->n(Landroid/graphics/Rect;)V
...
.method public d()Landroid/widget/ListView;
    ...
    invoke-interface {v0}, Lk/e;->getListView()Landroid/widget/ListView;
...
.method public l(Landroidx/appcompat/view/menu/j$a;)V
    ...
    .line 3
    invoke-interface {v0, p1}, Landroidx/appcompat/view/menu/j;->i(Landroidx/appcompat/view/menu/j$a;)V
...
.method public o()Z
    ...
    .line 3
    :cond_1
    invoke-direct {p0, v2, v2, v2, v2}, Landroidx/appcompat/view/menu/i;->n(IIZZ)V
...
.method public p(II)Z
    ...
    .line 3
    :cond_1
    invoke-direct {p0, p1, p2, v1, v1}, Landroidx/appcompat/view/menu/i;->n(IIZZ)V
