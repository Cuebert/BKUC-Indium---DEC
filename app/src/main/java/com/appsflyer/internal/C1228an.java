    ...
    public static synchronized String AFKeystoreWrapper(WeakReference<Context> weakReference) {
        synchronized (C1228an.class) {
            ...
            if (AFInAppEventType == null) {
                String str = null;
                if (weakReference.get() != null) {
                    str = C1219ae.values(weakReference.get()).getString("AF_INSTALLATION", null);
                }
                if (str != null) {
                    ...
                    try {
                        ...
                        SharedPreferences.Editor edit = C1219ae.values(weakReference.get()).edit();
                        edit.putString("AF_INSTALLATION", str2);
                        edit.apply();
                    } catch (Exception e10) {
                        AFLogger.AFInAppEventType("Error getting AF unique ID", e10);
                    }
                }
                if (AFInAppEventType != null) {
    ...
    */
    private static java.lang.String valueOf(java.io.File r6) {
        ...
        L52:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.C1228an.valueOf(java.io.File):java.lang.String");
    }
}
