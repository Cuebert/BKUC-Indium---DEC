...
public class LinearLayoutCompat extends ViewGroup {
    ...
    */
    void layoutVertical(int r18, int r19, int r20, int r21) {
        ...
        L59:
            ...
            r1 = r11
        L75:
            int r2 = androidx.core.view.C0690v.m3791E(r17)
            int r1 = androidx.core.view.C0670e.m3641b(r1, r2)
            r1 = r1 & 7
            if (r1 == r14) goto L8d
            r2 = 5
            if (r1 == r2) goto L88
    ...
    */
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i10) {
        ...
        int i11 = obtainStyledAttributes.getInt(C2957j.f12504h1, -1);
        if (i11 >= 0) {
            setOrientation(i11);
        }
        int i12 = obtainStyledAttributes.getInt(C2957j.f12499g1, -1);
        if (i12 >= 0) {
            setGravity(i12);
        }
        boolean z10 = obtainStyledAttributes.getBoolean(C2957j.f12509i1, true);
        if (!z10) {
            setBaselineAligned(z10);
        }
        this.mWeightSum = obtainStyledAttributes.getFloat(C2957j.f12519k1, -1.0f);
        this.mBaselineAlignedChildIndex = obtainStyledAttributes.getInt(C2957j.f12514j1, -1);
        this.mUseLargestChild = obtainStyledAttributes.getBoolean(C2957j.f12534n1, false);
        setDividerDrawable(obtainStyledAttributes.getDrawable(C2957j.f12524l1));
        this.mShowDividers = obtainStyledAttributes.getInt(C2957j.f12539o1, 0);
        this.mDividerPadding = obtainStyledAttributes.getDimensionPixelSize(C2957j.f12529m1, 0);
