...
public interface DecorToolbar {
    ...
    void setMenu(Menu menu, InterfaceC0173j.a aVar);

    void setMenuCallbacks(InterfaceC0173j.a aVar, C0168e.a aVar2);
    ...
    C0665b0 setupAnimatorToVisibility(int i10, long j10);
