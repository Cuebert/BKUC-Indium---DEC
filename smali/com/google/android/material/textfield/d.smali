...
.method private A(FFFI)Ly4/g;
    .locals 1

    .line 1
    invoke-static {}, Ly4/k;->a()Ly4/k$b;

    move-result-object v0

    .line 2
    invoke-virtual {v0, p1}, Ly4/k$b;->A(F)Ly4/k$b;

    move-result-object v0

    .line 3
    invoke-virtual {v0, p1}, Ly4/k$b;->E(F)Ly4/k$b;

    move-result-object p1

    .line 4
    invoke-virtual {p1, p2}, Ly4/k$b;->s(F)Ly4/k$b;

    move-result-object p1

    .line 5
    invoke-virtual {p1, p2}, Ly4/k$b;->w(F)Ly4/k$b;
    ...
    .line 8
    invoke-static {p2, p3}, Ly4/g;->m(Landroid/content/Context;F)Ly4/g;

    move-result-object p2

    .line 9
    invoke-virtual {p2, p1}, Ly4/g;->setShapeAppearanceModel(Ly4/k;)V

    const/4 p1, 0x0

    .line 10
    invoke-virtual {p2, p1, p4, p1, p4}, Ly4/g;->Z(IIII)V
...
.method private F(Landroid/widget/AutoCompleteTextView;)V
    ...
    .line 3
    iget-object v0, p0, Lcom/google/android/material/textfield/d;->m:Ly4/g;
...
.method private v(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Ly4/g;
    ...
    invoke-static {p1, v2}, Lo4/a;->c(Landroid/view/View;I)I
    ...
    .line 5
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->x(Landroid/widget/AutoCompleteTextView;I[[ILy4/g;)V
    ...
    .line 6
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->w(Landroid/widget/AutoCompleteTextView;I[[ILy4/g;)V
...
.method private w(Landroid/widget/AutoCompleteTextView;I[[ILy4/g;)V
    .locals 5
    ...
    .line 2
    invoke-static {p2, v0, v1}, Lo4/a;->f(IIF)I
    ...
    .line 6
    invoke-static {p1, p3}, Landroidx/core/view/v;->t0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 8
    invoke-virtual {p4}, Ly4/g;->C()Ly4/k;

    move-result-object v4

    invoke-direct {v0, v4}, Ly4/g;-><init>(Ly4/k;)V
    ...
    invoke-virtual {v0, v4}, Ly4/g;->X(Landroid/content/res/ColorStateList;)V
    ...
    .line 15
    invoke-static {p1, p2}, Landroidx/core/view/v;->t0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    .line 16
    invoke-static {p1, p3, p4, v0, v1}, Landroidx/core/view/v;->C0(Landroid/view/View;IIII)V

    :goto_0
    return-void
.end method

.method private x(Landroid/widget/AutoCompleteTextView;I[[ILy4/g;)V
    .locals 7

    .line 1
    sget v0, Li4/b;->l:I

    invoke-static {p1, v0}, Lo4/a;->c(Landroid/view/View;I)I
    ...
    .line 4
    invoke-static {p2, v0, v2}, Lo4/a;->f(IIF)I
    ...
    invoke-virtual {v1, v6}, Ly4/g;->X(Landroid/content/res/ColorStateList;)V
    ...
    .line 7
    invoke-virtual {v1, v0}, Ly4/g;->setTint(I)V
    ...
    invoke-direct {p3, v0}, Ly4/g;-><init>(Ly4/k;)V

    const/4 v0, -0x1

    .line 11
    invoke-virtual {p3, v0}, Ly4/g;->setTint(I)V
...
.method a()V
    ...
    .line 10
    invoke-direct {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)Ly4/g;
    ...
    .line 11
    invoke-direct {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/d;->A(FFFI)Ly4/g;

    move-result-object v0

    .line 12
    iput-object v3, p0, Lcom/google/android/material/textfield/d;->m:Ly4/g;
    ...
    invoke-static {v2, v0}, Lf/a;->d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
