...
public final class HiddenActivity$handleCreatePassword$1$1 extends AbstractC3845j implements InterfaceC3041l<SavePasswordResult, C4755l> {
    ...
    public /* bridge */ /* synthetic */ C4755l invoke(SavePasswordResult savePasswordResult) {
    ...
    public final void invoke2(SavePasswordResult savePasswordResult) {
        ...
        try {
            ...
            this.this$0.startIntentSenderForResult(savePasswordResult.m7312x().getIntentSender(), this.$requestCode, null, 0, 0, 0, null);
