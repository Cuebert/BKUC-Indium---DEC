...
public class TintContextWrapper extends ContextWrapper {
    ...
    private TintContextWrapper(Context context) {
        ...
        this.mResources = new C0264q(this, context.getResources());
        this.mTheme = null;
    }

    private static boolean shouldWrap(Context context) {
        return ((context instanceof TintContextWrapper) || (context.getResources() instanceof C0264q) || (context.getResources() instanceof VectorEnabledTintResources) || !VectorEnabledTintResources.shouldBeUsed()) ? false : true;
    }
