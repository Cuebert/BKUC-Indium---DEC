...
.method private d(Landroidx/lifecycle/l;)Landroidx/camera/lifecycle/LifecycleCameraRepository$LifecycleCameraRepositoryObserver;
    .locals 4
    ...
    .line 3
    invoke-virtual {v2}, Landroidx/camera/lifecycle/LifecycleCameraRepository$LifecycleCameraRepositoryObserver;->a()Landroidx/lifecycle/l;
...
.method private f(Landroidx/lifecycle/l;)Z
    .locals 4
    ...
    .line 2
    :try_start_0
    invoke-direct {p0, p1}, Landroidx/camera/lifecycle/LifecycleCameraRepository;->d(Landroidx/lifecycle/l;)Landroidx/camera/lifecycle/LifecycleCameraRepository$LifecycleCameraRepositoryObserver;
...
.method private g(Landroidx/camera/lifecycle/LifecycleCamera;)V
    ...
    .line 2
    :try_start_0
    invoke-virtual {p1}, Landroidx/camera/lifecycle/LifecycleCamera;->m()Landroidx/lifecycle/l;

    move-result-object v1

    .line 3
    invoke-virtual {p1}, Landroidx/camera/lifecycle/LifecycleCamera;->j()Lz/e;

    move-result-object v2

    invoke-virtual {v2}, Lz/e;->v()Lz/e$b;

    move-result-object v2

    .line 4
    invoke-static {v1, v2}, Landroidx/camera/lifecycle/LifecycleCameraRepository$a;->a(Landroidx/lifecycle/l;Lz/e$b;)Landroidx/camera/lifecycle/LifecycleCameraRepository$a;

    move-result-object v2

    .line 5
    invoke-direct {p0, v1}, Landroidx/camera/lifecycle/LifecycleCameraRepository;->d(Landroidx/lifecycle/l;)Landroidx/camera/lifecycle/LifecycleCameraRepository$LifecycleCameraRepositoryObserver;
    ...
    invoke-direct {p1, v1, p0}, Landroidx/camera/lifecycle/LifecycleCameraRepository$LifecycleCameraRepositoryObserver;-><init>(Landroidx/lifecycle/l;Landroidx/camera/lifecycle/LifecycleCameraRepository;)V
...
.method private j(Landroidx/lifecycle/l;)V
    .locals 3
...
.method private l(Landroidx/lifecycle/l;)V
    .locals 3
...
# virtual methods
.method a(Landroidx/camera/lifecycle/LifecycleCamera;Landroidx/camera/core/e3;Ljava/util/Collection;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroidx/camera/lifecycle/LifecycleCamera;",
            "Landroidx/camera/core/e3;",
    ...
    invoke-virtual {v2, p2}, Lz/e;->H(Landroidx/camera/core/e3;)V

    .line 11
    invoke-virtual {p1, p3}, Landroidx/camera/lifecycle/LifecycleCamera;->i(Ljava/util/Collection;)V
    :try_end_1
    ...
    invoke-virtual {p1, p2}, Landroidx/lifecycle/f$c;->b(Landroidx/lifecycle/f$c;)Z
    ...
    .line 13
    invoke-virtual {p0, v1}, Landroidx/camera/lifecycle/LifecycleCameraRepository;->h(Landroidx/lifecycle/l;)V
...
.method b(Landroidx/lifecycle/l;Lz/e;)Landroidx/camera/lifecycle/LifecycleCamera;
    .locals 3
    ...
    .line 2
    :try_start_0
    invoke-virtual {p2}, Lz/e;->v()Lz/e$b;

    move-result-object v1

    invoke-static {p1, v1}, Landroidx/camera/lifecycle/LifecycleCameraRepository$a;->a(Landroidx/lifecycle/l;Lz/e$b;)Landroidx/camera/lifecycle/LifecycleCameraRepository$a;
    ...
    sget-object v2, Landroidx/lifecycle/f$c;->n:Landroidx/lifecycle/f$c;
    ...
    invoke-direct {v1, p1, p2}, Landroidx/camera/lifecycle/LifecycleCamera;-><init>(Landroidx/lifecycle/l;Lz/e;)V

    .line 6
    invoke-virtual {p2}, Lz/e;->x()Ljava/util/List;
...
.method c(Landroidx/lifecycle/l;Lz/e$b;)Landroidx/camera/lifecycle/LifecycleCamera;
    .locals 2
    ...
    invoke-static {p1, p2}, Landroidx/camera/lifecycle/LifecycleCameraRepository$a;->a(Landroidx/lifecycle/l;Lz/e$b;)Landroidx/camera/lifecycle/LifecycleCameraRepository$a;
...
.method h(Landroidx/lifecycle/l;)V
    .locals 3
    ...
    .line 2
    :try_start_0
    invoke-direct {p0, p1}, Landroidx/camera/lifecycle/LifecycleCameraRepository;->f(Landroidx/lifecycle/l;)Z
    ...
    .line 8
    invoke-direct {p0, v1}, Landroidx/camera/lifecycle/LifecycleCameraRepository;->j(Landroidx/lifecycle/l;)V
    ...
    :cond_2
    :goto_0
    invoke-direct {p0, p1}, Landroidx/camera/lifecycle/LifecycleCameraRepository;->l(Landroidx/lifecycle/l;)V
...
.method i(Landroidx/lifecycle/l;)V
    .locals 2
    ...
    .line 3
    invoke-direct {p0, p1}, Landroidx/camera/lifecycle/LifecycleCameraRepository;->j(Landroidx/lifecycle/l;)V
...
.method k(Landroidx/lifecycle/l;)V
    .locals 4
    ...
    .line 4
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/camera/lifecycle/LifecycleCameraRepository;->i(Landroidx/lifecycle/l;)V
    ...
    .line 8
    invoke-virtual {v1}, Landroidx/camera/lifecycle/LifecycleCameraRepository$LifecycleCameraRepositoryObserver;->a()Landroidx/lifecycle/l;
    ...
    invoke-virtual {p1, v1}, Landroidx/lifecycle/f;->c(Landroidx/lifecycle/k;)V
