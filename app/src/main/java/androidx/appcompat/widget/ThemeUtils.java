...
public class ThemeUtils {
    ...
    public static void checkAppCompatTheme(View view, Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(C2957j.f12342B0);
        try {
            if (!obtainStyledAttributes.hasValue(C2957j.f12367G0)) {
    ...
    static int getThemeAttrColor(Context context, int i10, float f10) {
        return C0601a.m3180f(getThemeAttrColor(context, i10), Math.round(Color.alpha(r0) * f10));
    }
}
