...
.field private final f:Ly4/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILy4/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    .line 11
    iput-object p5, p0, Lcom/google/android/material/datepicker/a;->f:Ly4/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/a;
    ...
    .line 14
    invoke-static {p0, p1, v1}, Lv4/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    .line 25
    invoke-static {p0, v1, v0}, Ly4/k;->b(Landroid/content/Context;II)Ly4/k$b;

    move-result-object p0

    .line 26
    invoke-virtual {p0}, Ly4/k$b;->m()Ly4/k;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/a;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILy4/k;Landroid/graphics/Rect;)V
...
.method d(Landroid/widget/TextView;)V
    ...
    .line 3
    iget-object v2, p0, Lcom/google/android/material/datepicker/a;->f:Ly4/k;

    invoke-virtual {v0, v2}, Ly4/g;->setShapeAppearanceModel(Ly4/k;)V

    .line 4
    iget-object v2, p0, Lcom/google/android/material/datepicker/a;->f:Ly4/k;

    invoke-virtual {v1, v2}, Ly4/g;->setShapeAppearanceModel(Ly4/k;)V

    .line 5
    iget-object v2, p0, Lcom/google/android/material/datepicker/a;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Ly4/g;->X(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, v0}, Landroidx/core/view/v;->t0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
