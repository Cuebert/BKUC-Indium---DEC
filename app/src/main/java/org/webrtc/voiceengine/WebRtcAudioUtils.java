...
public final class WebRtcAudioUtils {
    ...
    private static void logAudioDeviceInfo(String str, AudioManager audioManager) {
        ...
        Logging.m17629b(str, "Audio Devices: ");
        for (AudioDeviceInfo audioDeviceInfo : devices) {
            ...
            Logging.m17629b(str, sb2.toString());
        }
    }
    ...
    private static void logAudioStateBasic(String str, AudioManager audioManager) {
        Logging.m17629b(str, "Audio State: audio mode: " + modeToString(audioManager.getMode()) + ", has mic: " + hasMicrophone() + ", mic muted: " + audioManager.isMicrophoneMute() + ", music active: " + audioManager.isMusicActive() + ", speakerphone: " + audioManager.isSpeakerphoneOn() + ", BT SCO: " + audioManager.isBluetoothScoOn());
    }

    private static void logAudioStateVolume(String str, AudioManager audioManager) {
        int[] iArr = {0, 3, 2, 4, 5, 1};
        Logging.m17629b(str, "Audio State: ");
        boolean isVolumeFixed = audioManager.isVolumeFixed();
        Logging.m17629b(str, "  fixed volume=" + isVolumeFixed);
        if (isVolumeFixed) {
            return;
        }
    ...
    static void logDeviceInfo(String str) {
        Logging.m17629b(str, "Android SDK: " + Build.VERSION.SDK_INT + ", Release: " + Build.VERSION.RELEASE + ", Brand: " + Build.BRAND + ", Device: " + Build.DEVICE + ", Id: " + Build.ID + ", Hardware: " + Build.HARDWARE + ", Manufacturer: " + Build.MANUFACTURER + ", Model: " + Build.MODEL + ", Product: " + Build.PRODUCT);
    }
    ...
    public static synchronized void setWebRtcBasedAutomaticGainControl(boolean z10) {
        synchronized (WebRtcAudioUtils.class) {
            Logging.m17632e(TAG, "setWebRtcBasedAutomaticGainControl() is deprecated");
        }
    }
    ...
    public static synchronized boolean useWebRtcBasedAcousticEchoCanceler() {
        ...
        synchronized (WebRtcAudioUtils.class) {
            if (useWebRtcBasedAcousticEchoCanceler) {
                Logging.m17632e(TAG, "Overriding default behavior; now using WebRTC AEC!");
            }
    ...
    public static synchronized boolean useWebRtcBasedNoiseSuppressor() {
        ...
        synchronized (WebRtcAudioUtils.class) {
            if (useWebRtcBasedNoiseSuppressor) {
                Logging.m17632e(TAG, "Overriding default behavior; now using WebRTC NS!");
            }
