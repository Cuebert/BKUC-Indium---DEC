...
public class ActionMenuView extends LinearLayoutCompat implements C0168e.b, InterfaceC0174k {
    ...
    private C0168e mMenu;
    C0168e.a mMenuBuilderCallback;
    private int mMinCellSize;
    OnMenuItemClickListener mOnMenuItemClickListener;
    private Context mPopupContext;
    private int mPopupTheme;
    private C0249b mPresenter;
    ...
    /* loaded from: classes.dex */
    public static class C0182a implements InterfaceC0173j.a {
        C0182a() {
        }
    ...
    /* loaded from: classes.dex */
    public class C0183b implements C0168e.a {
        C0183b() {
        }
        ...
        public void mo809b(C0168e c0168e) {
            C0168e.a aVar = ActionMenuView.this.mMenuBuilderCallback;
            if (aVar != null) {
                aVar.mo809b(c0168e);
            }
        }
    ...
    public static int measureChildForCells(View view, int i10, int i11, int i12, int i13) {
        ...
        boolean z10 = actionMenuItemView != null && actionMenuItemView.m924c();
        int i14 = 2;
        if (i11 <= 0 || (z10 && i11 < 2)) {
            i14 = 0;
        } else {
    ...
    private void onMeasureExactFormat(int i10, int i11) {
        ...
        while (i22 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                layoutParams.preventEdgeOffset = z14 && ((ActionMenuItemView) childAt).m924c();
    ...
    public Menu getMenu() {
        if (this.mMenu == null) {
            ...
            this.mMenu = c0168e;
            c0168e.mo997R(new C0183b());
            C0249b c0249b = new C0249b(context);
            this.mPresenter = c0249b;
            c0249b.m1170L(true);
            C0249b c0249b2 = this.mPresenter;
            InterfaceC0173j.a aVar = this.mActionMenuPresenterCallback;
            if (aVar == null) {
                aVar = new C0182a();
            }
            c0249b2.mo938i(aVar);
            this.mMenu.m1008c(this.mPresenter, this.mPopupContext);
            this.mPresenter.m1168J(this);
        }
        return this.mMenu;
    }
    ...
    public boolean hideOverflowMenu() {
        C0249b c0249b = this.mPresenter;
        return c0249b != null && c0249b.m1161C();
    }
    ...
    public boolean invokeItem(C0170g c0170g) {
        return this.mMenu.m992L(c0170g, 0);
    }

    public boolean isOverflowMenuShowPending() {
        C0249b c0249b = this.mPresenter;
        return c0249b != null && c0249b.m1163E();
    }

    public boolean isOverflowMenuShowing() {
        C0249b c0249b = this.mPresenter;
        return c0249b != null && c0249b.m1164F();
    }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        if (c0249b != null) {
            c0249b.mo935d(false);
            if (this.mPresenter.m1164F()) {
                this.mPresenter.m1161C();
                this.mPresenter.m1171M();
            }
        }
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        int size = View.MeasureSpec.getSize(i10);
        if (this.mFormatItems && (c0168e = this.mMenu) != null && size != this.mFormatItemsWidth) {
    ...
    public C0168e peekMenu() {
        return this.mMenu;
    }

    public void setExpandedActionViewsExclusive(boolean z10) {
        this.mPresenter.m1167I(z10);
    }
    ...
    public void setOverflowIcon(Drawable drawable) {
        getMenu();
        this.mPresenter.m1169K(drawable);
    }
    ...
    public void setPresenter(C0249b c0249b) {
        this.mPresenter = c0249b;
        c0249b.m1168J(this);
    }
    ...
    public boolean showOverflowMenu() {
        C0249b c0249b = this.mPresenter;
        return c0249b != null && c0249b.m1171M();
    }
