...
public class SwitchCompat extends CompoundButton {
    ...
    private static final Property<SwitchCompat, Float> THUMB_POS = new C0240a(Float.class, "thumbPos");
    private static final int[] CHECKED_STATE_SET = {R.attr.state_checked};

    /* renamed from: androidx.appcompat.widget.SwitchCompat$a */
    /* loaded from: classes.dex */
    class C0240a extends Property<SwitchCompat, Float> {
        C0240a(Class cls, String str) {
            super(cls, str);
        }
        ...
        if (drawable != null) {
            if (this.mHasThumbTint || this.mHasThumbTintMode) {
                ...
                if (this.mHasThumbTint) {
                    C0609a.m3260o(mutate, this.mThumbTintList);
                }
                if (this.mHasThumbTintMode) {
                    C0609a.m3261p(this.mThumbDrawable, this.mThumbTintMode);
                }
        ...
        if (drawable != null) {
            if (this.mHasTrackTint || this.mHasTrackTintMode) {
                ...
                if (this.mHasTrackTint) {
                    C0609a.m3260o(mutate, this.mTrackTintList);
                }
                if (this.mHasTrackTintMode) {
                    C0609a.m3261p(this.mTrackDrawable, this.mTrackTintMode);
                }
    ...
    private void setOffStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(C2955h.f12317d);
            }
            C0690v.m3794F0(this, charSequence);
        }
    }
    ...
    private void setOnStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (charSequence == null) {
                charSequence = getResources().getString(C2955h.f12318e);
            }
            C0690v.m3794F0(this, charSequence);
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable3 != null) {
            ...
            if (background != null) {
                C0609a.m3257l(background, i24, i13, i25, i15);
            }
        }
        super.draw(canvas);
    }
    ...
    public void drawableHotspotChanged(float f10, float f11) {
        ...
        Drawable drawable2 = this.mTrackDrawable;
        if (drawable2 != null) {
            C0609a.m3256k(drawable2, f10, f11);
        }
    }
    ...
    */
    ...
    public void setChecked(boolean z10) {
        ...
        if (getWindowToken() != null && C0690v.m3814U(this)) {
    ...
    public void setSwitchTextAppearance(Context context, int i10) {
        ...
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C2957j.f12486d3);
        if (colorStateList != null) {
            this.mTextColors = colorStateList;
        } else {
            this.mTextColors = getTextColors();
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C2957j.f12470a3, 0);
        ...
        setSwitchTypefaceByIndex(obtainStyledAttributes.getInt(C2957j.f12476b3, -1), obtainStyledAttributes.getInt(C2957j.f12481c3, -1));
        if (obtainStyledAttributes.getBoolean(C2957j.f12521k3, false)) {
            this.mSwitchTransformationMethod = new C3464a(getContext());
        } else {
    ...
    public void setThumbResource(int i10) {
        setThumbDrawable(C3121a.m13770d(getContext(), i10));
    }
    ...
    public void setTrackResource(int i10) {
        setTrackDrawable(C3121a.m13770d(getContext(), i10));
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2948a.f12145N);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i10) {
        ...
        Drawable drawable = obtainStyledAttributes.getDrawable(C2957j.f12404N2);
        this.mThumbDrawable = drawable;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        Drawable drawable2 = obtainStyledAttributes.getDrawable(C2957j.f12449W2);
        this.mTrackDrawable = drawable2;
        if (drawable2 != null) {
            drawable2.setCallback(this);
        }
        this.mTextOn = obtainStyledAttributes.getText(C2957j.f12394L2);
        this.mTextOff = obtainStyledAttributes.getText(C2957j.f12399M2);
        this.mShowText = obtainStyledAttributes.getBoolean(C2957j.f12409O2, true);
        this.mThumbTextPadding = obtainStyledAttributes.getDimensionPixelSize(C2957j.f12434T2, 0);
        this.mSwitchMinWidth = obtainStyledAttributes.getDimensionPixelSize(C2957j.f12419Q2, 0);
        this.mSwitchPadding = obtainStyledAttributes.getDimensionPixelSize(C2957j.f12424R2, 0);
        this.mSplitTrack = obtainStyledAttributes.getBoolean(C2957j.f12414P2, false);
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(C2957j.f12439U2);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode parseTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C2957j.f12444V2, -1), null);
        ...
        ColorStateList colorStateList2 = obtainStyledAttributes.getColorStateList(C2957j.f12454X2);
        if (colorStateList2 != null) {
            this.mTrackTintList = colorStateList2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode parseTintMode2 = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(C2957j.f12459Y2, -1), null);
        ...
        int resourceId = obtainStyledAttributes.getResourceId(C2957j.f12429S2, 0);
        if (resourceId != 0) {
