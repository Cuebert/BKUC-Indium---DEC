...
.method protected constructor <init>(Lx2/f;)V
    .locals 2
    ...
    .line 9
    invoke-virtual {p1}, Lx2/f;->d()Landroid/os/Looper;
...
.method private final h()Lx2/m;
    ...
    invoke-static {v1, v3}, Lz2/j;->n(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lx2/m;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lx2/m;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lx2/n;
...
.method private final i(Lx2/m;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TR;)V"
    ...
    .line 1
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lx2/m;

    invoke-interface {p1}, Lx2/m;->q()Lcom/google/android/gms/common/api/Status;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->m:Lz2/d;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lx2/n;

    goto :goto_0

    .line 3
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lx2/n;

    if-nez v0, :cond_1

    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lx2/m;

    .line 4
    instance-of v0, v0, Lx2/j;

    if-eqz v0, :cond_2

    new-instance v0, Lcom/google/android/gms/common/api/internal/g0;

    invoke-direct {v0, p0, p1}, Lcom/google/android/gms/common/api/internal/g0;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;Ly2/g0;)V
    ...
    .line 6
    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h()Lx2/m;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult$a;->a(Lx2/n;Lx2/m;)V
    ...
    .line 9
    invoke-interface {v2, v3}, Lx2/h$a;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method static bridge synthetic j(Lcom/google/android/gms/common/api/internal/BasePendingResult;)Lx2/m;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lx2/m;

    return-object p0
.end method

.method public static l(Lx2/m;)V
    .locals 2
...
# virtual methods
.method public final b(Lx2/h$a;)V
    .locals 2
    ...
    .line 3
    invoke-interface {p1, v1}, Lx2/h$a;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final c(JLjava/util/concurrent/TimeUnit;)Lx2/m;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 1
    invoke-static {v0}, Lz2/j;->i(Ljava/lang/String;)V
    ...
    .line 2
    invoke-static {v0, v2}, Lz2/j;->n(ZLjava/lang/Object;)V

    const-string v0, "Cannot await if then() has been called."

    .line 3
    invoke-static {v1, v0}, Lz2/j;->n(ZLjava/lang/Object;)V
    ...
    invoke-static {p1, p2}, Lz2/j;->n(ZLjava/lang/Object;)V
...
.method protected abstract d(Lcom/google/android/gms/common/api/Status;)Lx2/m;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final g(Lx2/m;)V
    ...
    .line 4
    invoke-direct {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->i(Lx2/m;)V
    ...
    .line 6
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->l(Lx2/m;)V
