...
public final class C1274j {
    ...
    public static C1274j AFInAppEventType() {
        if (init == null) {
            init = new C1274j();
        }
        return init;
    ...
    */
    public final void AFKeystoreWrapper(java.util.Map<java.lang.String, java.lang.Object> r5, com.appsflyer.internal.C1235au r6, android.content.Intent r7, android.content.Context r8) {
        /*
            r4 = this;
            android.content.SharedPreferences r0 = com.appsflyer.internal.C1219ae.values(r8)
            ...
            r1 = 0
            int r5 = com.appsflyer.internal.C1219ae.valueOf(r0, r5, r1)
            if (r5 != 0) goto L97
            ...
            r8.start()
            r8 = 0
            long r1 = com.appsflyer.internal.C1231aq.onInstallConversionDataLoadedNative     // Catch: java.util.concurrent.TimeoutException -> L4d java.lang.InterruptedException -> L7a java.util.concurrent.ExecutionException -> L7c
        ...
        L4d:
            ...
            r6.append(r1)
            long r1 = com.appsflyer.internal.C1231aq.onInstallConversionDataLoadedNative
            r6.append(r1)
        ...
        L97:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.C1274j.AFKeystoreWrapper(java.util.Map, com.appsflyer.internal.au, android.content.Intent, android.content.Context):void");
    }
    ...
    public final void AFInAppEventType(final Context context, final Map<String, Object> map, final Uri uri) {
        if (AFInAppEventParameterName(uri.toString())) {
            ...
            c1275k.AFInAppEventParameterName.execute(new Runnable() { // from class: com.appsflyer.internal.j.1
                private static Map<String, Object> AFInAppEventType(Uri uri2) {
                    ...
                    try {
                        ...
                        int i10 = C1274j.AFInAppEventType;
                ...
                public final void run() {
                    ...
                    while (i10 < 5) {
                        ...
                        if (str2 == null || !C1274j.AFInAppEventParameterName(str2)) {
                            str = str3;
                            obj = str2;
                            num = num2;
                            break;
                    ...
                    C1219ae.values().AFInAppEventParameterName(context, map, obj != null ? Uri.parse(obj) : uri);
                    C1274j.valueOf = false;
                }
            });
        } else {
            C1219ae.values().AFInAppEventParameterName(context, map, uri);
        }
        values = null;
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:26:? A[LOOP:0: B:17:0x0040->B:26:?, LOOP_END, SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean AFKeystoreWrapper(android.content.Intent r9, android.content.Context r10, java.util.Map<java.lang.String, java.lang.Object> r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.C1274j.AFKeystoreWrapper(android.content.Intent, android.content.Context, java.util.Map):boolean");
    }
